// Parity test for the client-side mirror of the engine's name-validation.
// All cases below are copied verbatim from tests/engine/name-validation.test.ts -
// if they diverge, the mirror in src/web/lib/name-validation.ts has drifted from
// src/engine/name-validation.ts and must be re-synced.
...
describe('getItemNameError (web mirror)', () => {
...
describe('getNameVsSiblingsError (web mirror)', () => {
